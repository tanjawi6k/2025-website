...
const services = [
  {
    ...
    alt: "Icône de maintenance représentant une clé à molette",
    description:
  ...
  },
  {
    ...
    alt: "Icône de développement web représentant des lignes de commandes sur pc",
    description:
  ...
  },
  {
    ...
    alt: "Icône de NFC représentant une puce nfc",
    description:
  ...
  },
  {
    ...
    alt: "Icône de sécurité représentant un bureau de sécurité équipé de caméras",
    description:
          ...
          >
            <div className="card-body">
              <div className="h-16 w-16 rounded-full bg-gradient-to-t from-base-300/20 to-base-content/10">
                <img className="p-4" src={item.icon} alt={item.alt} />
              </div>
